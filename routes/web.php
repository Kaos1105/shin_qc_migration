...
Route::get('/cannot-login', 'HomeController@cannotLogin')->name('cannotLogin');
Route::get('/send-question', 'HomeController@sendQuestion')->name('sendQuestion');
Route::get('/update-session', 'HomeController@updateSession')->name('updateSession')->middleware('auth');
Route::get('/top-page', 'ToppageController@index')->name('toppageoffice')->middleware('auth');
Route::get('/test-session', 'HomeController@testSession')->name('testSession')->middleware('auth');
Route::get('/test-url', 'HomeController@testUrl')->name('testUrl');

Route::post('/keep-sort', 'KeepSortController@postSortKeys')->name('keep-sort');
...
Route::group(['middleware' => ['App\Http\Middleware\AdminMiddleware', 'auth']], function () {
    ...
    Route::get('/circle/{id}/edit', 'CircleController@edit');
    Route::put('/circle/{id}', 'CircleController@update');
    Route::delete('/circle/{id}', 'CircleController@destroy');

    Route::resource('/member', 'MemberController');
    Route::get('/member/{id}/create', 'MemberController@create');
    Route::get('/member/{id}/edit', 'MemberController@edit');
    Route::put('/member/{id}', 'MemberController@update');
    Route::delete('/member/{id}', 'MemberController@destroy');

    Route::resource('/planbyyear', 'PlanByYearController');
    Route::get('/planbyyear/history', 'PlanByYearController@show');
