...
@section('content')
    ...
    <div class="container-fluid">
        <form id="form-register" method="POST" enctype="multipart/form-data"
              action="{{ action('EducationalMaterialsController@store') }}">
            @csrf
            <table class="table-form" border="1">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="qc-form-input input-m" id="educational_materials_type" name="educational_materials_type"
                               value="{{old('educational_materials_type')}}"/>
                    </td>
                </tr>
                <tr>
