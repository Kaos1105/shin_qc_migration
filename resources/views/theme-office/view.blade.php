...
@section('breadcrumbs')
    {{
        ...
        Breadcrumbs::for('list', function ($trail) {
            ...
            $trail->push('テーマ管理',URL::to('theme-office/list'));
        }),
...
@section('content')
    <div class="float-right btn-area">
        ...
        @else
            <a class="btn btn-back" href="{{ URL::to('theme-office/list') }}">戻る</a>
        @endif
    </div>
    <div class="container-fluid bottom-fix" id="77777">
        ...
        <table class="table-form-BG" id="table-promotion-theme" border="1" style="width: 100%">
            ...
            <tr>
                <td class="background-c">1.テーマ選定</td>
                @if($number_month > 0)
                    ...
                    @endif
                @endif
                <td><span class="line-brake-preserve">{{ isset($promotion_theme_1)? ($promotion_theme_1->note) : null }}</span></td>
            </tr>
            <tr>
                <td class="background-c">2.現状把握と目標設定</td>
                @if($number_month > 0)
                    @for($i = 0; $i < $number_month; $i++)
                        <td></td>
                    @endfor
            ...
            <tr>
                <td class="background-c">3.活動計画の作成</td>
                @if($number_month > 0)
                    @for($i = 0; $i < $number_month; $i++)
                        <td></td>
                    @endfor
            ...
            <tr>
                <td class="background-c">4.要因解析</td>
                @if($number_month > 0)
                    @for($i = 0; $i < $number_month; $i++)
                        <td></td>
                    @endfor
            ...
            <tr>
                <td class="background-c">5.対策検討と実施</td>
                @if($number_month > 0)
                    @for($i = 0; $i < $number_month; $i++)
                        <td></td>
                    @endfor
            ...
            <tr>
                <td class="background-c">6.効果確認</td>
                @if($number_month > 0)
                    @for($i = 0; $i < $number_month; $i++)
                        <td></td>
                    @endfor
            ...
            <tr>
                <td class="background-c">7.標準化と管理の定着</td>
                @if($number_month > 0)
                    @for($i = 0; $i < $number_month; $i++)
                        <td></td>
                    @endfor
