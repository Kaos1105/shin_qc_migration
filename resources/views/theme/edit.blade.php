...
@section('content')
    ...
    <div class="container-fluid">
        {{ Form::model($theme, array('route' => array('theme.update', $theme->id), 'method' => 'PUT', 'id' => 'form-register')) }}
        @csrf
        <table class="table-form" border="1">
            <tr>
                <td class="td-first">{{ __('登録ID') }}</td>
                <td>
                    <span>{{ isset($theme)? App\Enums\Common::show_id($theme['id']):null }}</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="qc-form-input input-m" name="value_property"
                           value="{{ old('value_property', isset($theme)?$theme['value_property']:null)}}" required>
                    <span class="qc-form-required">必須</span>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="qc-form-input input-m" name="value_objective"
                           value="{{ old('value_objective', isset($theme)?$theme['value_objective']:null)}}" required>
                    <span class="qc-form-required">必須</span>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="date-icon-1" class="date-selector-icon" src="{{asset('/images/calendar_24px.png')}}" alt="">
                    <span class="qc-form-required">必須</span>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="qc-form-input input-s qc-datepicker" id="date_expected_completion"
                           value="{{ old('date_expected_completion', isset($theme->date_expected_completion)? date("Y/m/d", strtotime($theme['date_expected_completion'])) : null)}}"
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="qc-form-input input-s qc-datepicker" id="date_actual_completion"
                           value="{{ old('date_actual_completion', isset($theme->date_actual_completion)? date("Y/m/d", strtotime($theme['date_actual_completion'])) : null)}}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#date_start").datepicker("option", "maxDate", $("#date_expected_completion").val());
            $("#date_expected_completion").datepicker("option", "minDate", $("#date_start").val());
            $("#date_actual_completion").datepicker("option", "minDate", $("#date_start").val());
